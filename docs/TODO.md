# ✅ European Portuguese Flashcards App — Feature TODO List (Easy → Hard)
...
- [x] Create static JSON or TS file with flashcards grouped by category (animals, food, verbs)  
  ✅ *Acceptance Criteria:* File exports at least 3 cards per category with correct format: `portuguese`, `english`, `category`, and `quiz`.
...
- [x] Create `Flashcard` component to show:
  - [x] Portuguese word (front side)  
    ✅ *Acceptance Criteria:* Portuguese word is displayed by default.
...
- [ ] Implement Multiple Choice Quiz:
  - [ ] Display Portuguese word  
    ✅ *Acceptance Criteria:* Portuguese word is clearly shown at the top.
...
- [ ] Implement Fill-in-the-Blank Quiz:
  - [ ] Display Portuguese word  
    ✅ *Acceptance Criteria:* Portuguese word is visible as the prompt.
